...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.publicacion'
        db.add_column(u'tutoriales_tutorial', 'publicacion',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.publicacion'
        db.delete_column(u'tutoriales_tutorial', 'publicacion')
