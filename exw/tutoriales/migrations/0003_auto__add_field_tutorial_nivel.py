...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.nivel'
        db.add_column(u'tutoriales_tutorial', 'nivel',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.nivel'
        db.delete_column(u'tutoriales_tutorial', 'nivel')
    ...
    models = {
        ...
        u'tutoriales.tutorial': {
            ...
            'nivel': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'blank': 'True'}),
